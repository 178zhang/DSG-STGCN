...
% 
% sa = sa
% data = truth.source_amp(sa.cortex2K.in_to_cortex75K_geod, 1)
% colorlimits = [0 ma]
% cm = cm17a
% unit = 'A.U.'
% smooth = 1
% printfolder = ['figures/' dataset_string '/truth/dataset' num2str(idata) '/source1']
% varargin: 在.m中设计可变参数函数，只要将最后一个参数设置为varargin，就可以实现。
% 
